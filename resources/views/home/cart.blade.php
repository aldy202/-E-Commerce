                            ...
                            <table class="shop_table cart table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="product-quantity">Quntity</th>
                                    ...
                                    @foreach ($carts as $cart)
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-thumbnail">
                                                <a href="#">
                                                    <img src="/storage/products/{{ $cart->product->gambar }}"
                                                        alt="">
                                                </a>
                                            </td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 shipping-calculator-form">
                        ...
                        <p class="form-row form-row-wide">
                            <select name="provinsi" id="provinsi" class="country_to_state provinsi" rel="provinsi">
                        ...
                        <div class="row row-10">
                            <div class="col-sm-12">
                                <p class="form-row form-row-wide">
                                    <input type="text" class="input-text" placeholder="Detail Alamat"
                            ...
                            <table class="table shop_table">
                                <tbody>
                                    <tr class="cart-subtotal">
                                        ...
                                        <td>
                                            <span>Rp. </span><span
                                                class="amount cart-total">{{ $cart_total}}</span>
                                        </td>
                                    </tr>
                                    <tr class="shipping">
                                        <th>Shipping</th>
                                    ...
                                    <tr class="order-total">
                                        ...
                                        <td>
                                            ...
                                            <strong><span class="amount grand-total"></span></strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        $(function() {
            ...
            $('.update-total').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        data = JSON.parse(data);
                        grand_total = data.rajaongkir.results[0].costs[0].cost[0].value +
                            parseInt($('.cart-total').text());
                        console.log(grand_total)
                        $('.shipping-cost').html(data.rajaongkir.results[0].costs[0]
                            .cost[0]
                            .value);
