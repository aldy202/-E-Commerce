            ...
            <div class="row">
                ...
                <div class="ecommerce col-xs-12">
                    ...
                    <form name="checkout" class="checkout ecommerce-checkout row" method="POST" action="/payments">
                        @csrf
                        <input type="text" name="id_order" value="{{ $orders->id }}">
                        <div class="col-md-8" id="customer_details">
                            <div>
                                ...
                                <p class="form-row form-row-first validate-required ecommerce-invalid ecommerce-invalid-required-field"
                                    ...
                                    <select name="kabupaten" id="kabupaten" class="country_to_state kota" rel="calc_shipping_state">
                                    </select>
                                </p>
                                <p class="form-row form-row-first validate-required ecommerce-invalid ecommerce-invalid-required-field"
                                    id="billing_first_name_field">
                                ...
                                <table class="table shop_table ecommerce-checkout-review-order-table">
                                    <tbody>
                                        ...
                                        <tr class="order-total">
                                            ...
                                            <td>
                                                <strong><span class="amount">{{ number_format($orders->total) }}</span></strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
