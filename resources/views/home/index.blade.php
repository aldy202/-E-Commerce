    ...
    <section class="hero-wrap text-center relative">
        <div id="owl-hero" class="owl-carousel owl-theme light-arrows slider-animated">
            @foreach ($sliders as $slider)
                <div class="hero-slide overlay" style="background-image:url(/storage/sliders/{{ $slider->gambar }})">
                    <div class="container">
            ...
            <div class="row">
                ...
                @foreach ($categories as $category)
                    <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
                        <a href="#">
                            <img src="/storage/menus/{{ $category->gambar }}" alt="">
                                ...
                                <div class="hover-overlay">
                                    ...
                                    <div class="product-details valign">
                                        ...
                                        <h3 class="product-title">
                                            <a href="/products/{{ $product->id }}">{{ $product->nama_barang }}</a>
                                        </h3>
                                        <span class="price">
                                            <ins>
                                        ...
                                        <div class="btn-quickview">
                                            <a href="/product/" class="btn btn-md btn-color">
                                                <span>More</span>
                                            </a>
                                        </div>
                                    </div>
